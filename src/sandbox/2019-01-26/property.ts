...
export module Property {
    ...
    export type Array<V extends any[], K extends string> = Property<V, K>;

    export module Array {
        export type Keys<T> = Exclude<{ [P in keyof T]: T[P] extends Property<any[], infer K> ? K : never }[keyof T], undefined>;
    }
