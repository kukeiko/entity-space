import { Class, Path, Primitive, entryValueIs, isDefined } from "@entity-space/utils";
import { isPlainObject } from "lodash";
import { EntityBlueprintInstance } from "./entity-blueprint-instance.type.mjs";
import {
    ArrayAttribute,
    BlueprintProperty,
    DtoAttribute,
...
import { RelationshipType } from "./entity-relation-property.mjs";
...
export namespace EntityBlueprint {
    ...
    export const dictionary = true;
    export const nullable = true;
    export const optional = true;
    export const readonly = true;
    export const unique = true;

    type IdOptions = Partial<DtoAttribute>;

    export function id<O extends IdOptions>(options?: O): BlueprintProperty<typeof Number> & IdAttribute & O;
    export function id<O extends IdOptions, V extends Primitive = typeof Number>(
        valueType?: V,
        options?: O,
    ): BlueprintProperty<V> & IdAttribute & O;
    export function id(...args: any[]): BlueprintProperty & IdAttribute & IdOptions {
        ...
        return { id: true, valueType, ...options };
    }

    type PrimitiveOptions = Partial<ArrayAttribute & DtoAttribute & NullableAttribute & OptionalAttribute>;
    ...
    type EntityOptions = Partial<ArrayAttribute & DtoAttribute & NullableAttribute & OptionalAttribute>;
