...
describe("reducing: in-set", () => {
    ...
    describe("full reduction", () => {
        reducing("{1, 2, 3}").by("{1, 2, 3}").is(true);
        reducing("{1, 2, 3}").by("{1, 2, 3, 4}").is(true);
        reducing("{1, 2, 3}").by("!{4}").is(true);
    });
    ...
    describe("partial reduction", () => {
        reducing("{1, 2, 3}").by("{1, 2, 4}").is("{3}");
        reducing("{1, 2, 3}").by("!{1}").is("{1}");
    });
    ...
    describe("no reduction", () => {
        reducing("{1, 2, 3}").by("{4, 5, 6}").is(false);
        reducing("{1, 2, 3}").by("!{1, 2, 3}").is(false);
        reducing("{1, 2, 3}").by("[1, 3]").is(false);
    });
});
