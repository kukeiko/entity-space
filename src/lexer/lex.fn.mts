import { scanLiteral } from "./scan-literal.fn.mjs";
import { scanNumber } from "./scan-number.fn.mjs";
import { scanString } from "./scan-string.fn.mjs";
import { Token, token, TokenType } from "./token.mjs";
