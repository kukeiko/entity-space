...
import { parseJson } from "../../lib/lexer/json-parser/parse-json.fn";

describe("parseJson()", () => {
    function shouldParse(stringified: string, expected: Json, specFn = it): void {
    ...
    shouldParse("4e4", 40000, xit);
    shouldParse("3.212341234412e6", 3212341.234412, xit);
